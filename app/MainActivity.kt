...
class MainActivity : AppCompatActivity(), ConnectChecker, SurfaceHolder.Callback {
    ...
    // Adaptive bitrate: when the network can't sustain the target bitrate,
    // reduce quality smoothly instead of freezing; climb back on recovery.
    ...
    private fun startAll() {
        ...
        // toward the target. Video quality dips instead of freezing.
